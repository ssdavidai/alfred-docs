...
<Info>
The default for all three flags is `"live"`. The resolver source-of-truth comments document the precedence rules in code *(`packages/learn/src/activities/state_mutator.py:200-211`)*.
</Info>

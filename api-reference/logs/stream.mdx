...
Stream logs from one or more services in real-time using Server-Sent Events (SSE). This is a long-lived connection that streams log lines as they are produced by `docker compose logs`.

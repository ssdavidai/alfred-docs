...
The dashboard ships as **two images**, not one. This bit early adopters
hard — UI changes need *both* redeployed plus a hard browser refresh.
...
- Frozen contracts web participates in: `docs/FIX-CONTRACTS.md` (C4, C8, C13, C14, C15, C16, C17, C18, C19)
